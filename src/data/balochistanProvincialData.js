...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/provincialBody/balochistan/image${imageNumber}.jpg`,
...
const balochistanProvincialData = {
  title: "Balochistan Provincial Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/provincialBody/balochistan/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Balochistan Member 06", 6),
    createProfile("Balochistan Member 07", 7),
    createProfile("Balochistan Member 08", 8),
    createProfile("Balochistan Member 09", 9),
    createProfile("Balochistan Member 10", 10),
    createProfile("Balochistan Member 11", 11),
    createProfile("Balochistan Member 12", 12),
    createProfile("Balochistan Member 13", 13),
    createProfile("Balochistan Member 14", 14),
    createProfile("Balochistan Member 15", 15),
  ],
};

export default balochistanProvincialData;