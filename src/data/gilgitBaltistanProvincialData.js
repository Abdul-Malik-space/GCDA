...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/provincialBody/gilgit-baltistan/image${imageNumber}.jpeg`,
...
const gilgitBaltistanProvincialData = {
  title: "Gilgit Baltistan Provincial Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/provincialBody/gilgit-baltistan/image1.jpeg",
  ...
  profiles: [
    ...
    createProfile("Gilgit Baltistan Member 06", 6),
    createProfile("Gilgit Baltistan Member 07", 7),
    createProfile("Gilgit Baltistan Member 08", 8),
    createProfile("Gilgit Baltistan Member 09", 9),
    createProfile("Gilgit Baltistan Member 10", 10),
    createProfile("Gilgit Baltistan Member 11", 11),
    createProfile("Gilgit Baltistan Member 12", 12),
    createProfile("Gilgit Baltistan Member 13", 13),
    createProfile("Gilgit Baltistan Member 14", 14),
    createProfile("Gilgit Baltistan Member 15", 15),
  ],
};

export default gilgitBaltistanProvincialData;