...
const createProfile = (
  ...
  image: `/assets/images/about/patrons/image${imageNumber}.${extension}`,
...
const patronsData = {
  ...
  heroImage: "/assets/images/about/patrons/hero.jpg",

  profiles: [
    createProfile(
      "Dr Masood Akhtar Sheikh",
      1,
      "Senior patron associated with GCDA, contributing to doctors welfare, service matters, medical leadership, and professional coordination."
    ),
