...
const createProfile = (
  ...
  image: `/assets/images/about/chief-patron/image${imageNumber}.${extension}`,
...
const chiefPatronData = {
  title: "Chief Patron",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/about/chief-patron/hero.jpg",
...
export default chiefPatronData;