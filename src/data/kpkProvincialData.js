...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/provincialBody/kpk/image${imageNumber}.jpeg`,
...
const kpkProvincialData = {
  title: "KPK Provincial Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/provincialBody/kpk/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("KPK Member 06", 6),
    createProfile("KPK Member 07", 7),
    createProfile("KPK Member 08", 8),
    createProfile("KPK Member 09", 9),
    createProfile("KPK Member 10", 10),
    createProfile("KPK Member 11", 11),
    createProfile("KPK Member 12", 12),
    createProfile("KPK Member 13", 13),
    createProfile("KPK Member 14", 14),
    createProfile("KPK Member 15", 15),
  ],
};

export default kpkProvincialData;