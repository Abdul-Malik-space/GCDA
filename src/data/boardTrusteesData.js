...
const createProfile = (
  ...
  image: `/assets/images/about/board-of-trustees/image${imageNumber}.${extension}`,
...
const boardTrusteesData = {
  ...
  heroImage: "/assets/images/about/board-of-trustees/hero.jpg",
  ...
  profiles: [
    createProfile(
      ...
      "Central HQ",
      "Board of Trustees member associated with GCDA, contributing to doctors welfare, governance, legal structure, and healthcare administration."
    ),

    createProfile("Dr Muhammad Arif", 2, "Trustee Member", "Multan"),
    createProfile("Dr Salman Kazmi", 3, "Trustee Member", "Lahore"),
    createProfile("Dr Shahzad Ali", 4, "Trustee Member", "Faisalabad"),
    createProfile("Dr Asad Shahzad", 5, "Chairman Executive Committee", "Rawalpindi"),
    createProfile("Dr Naveed Iqbal", 6, "Trustee Member", "Lahore"),

    createProfile("Dr Rana Rafique", 7, "Senior Trustee", "Gujranwala"),
    createProfile("Dr Amjad Khan", 8, "Trustee Member", "Sahiwal"),
    createProfile("Dr Tariq Mahmood", 9, "Trustee Member", "Karachi"),
    createProfile("Dr Ayesha Siddiqua", 10, "Trustee Member Ladies Wing", "Lahore"),
    createProfile("Dr Bilal Ahmed", 11, "Trustee Secretary", "Sialkot"),

    createProfile("Dr Zainab Raza", 12, "Finance Trustee", "Lahore"),
    createProfile("Dr Hamza Ali", 13, "Information Trustee", "Bahawalpur"),
    createProfile("Dr Maryam Khan", 14, "Legal Affairs Trustee", "Islamabad"),
    createProfile("Dr Usman Yusuf", 15, "Executive Trustee", "Sargodha"),
    createProfile("Dr Fatima Sheikh", 16, "Executive Trustee", "Jhang"),

    createProfile("Dr Omer Farooq", 17, "Trustee Member", "Sheikhupura"),
    createProfile("Dr Sana Malik", 18, "Trustee Member", "Kasur"),
    createProfile("Dr Kashif Raza", 19, "Co-opted Trustee", "Okara"),
    createProfile("Dr Hina Batool", 20, "Co-opted Trustee", "Chiniot"),
    createProfile("Dr Faisal Javed", 21, "Co-opted Trustee", "Mianwali"),
  ],
};

export default boardTrusteesData;