...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/dg-khan-district/image${imageNumber}.jpg`,
...
const dgKhanDistrictData = {
  title: "DG Khan District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/dg-khan-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("DG Khan Member 06", 6),
    createProfile("DG Khan Member 07", 7),
    createProfile("DG Khan Member 08", 8),
    createProfile("DG Khan Member 09", 9),
    createProfile("DG Khan Member 10", 10),
    createProfile("DG Khan Member 11", 11),
    createProfile("DG Khan Member 12", 12),
    createProfile("DG Khan Member 13", 13),
    createProfile("DG Khan Member 14", 14),
    createProfile("DG Khan Member 15", 15),
  ],
};

export default dgKhanDistrictData;