...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/chiniot-district/image${imageNumber}.jpg`,
...
const chiniotDistrictData = {
  title: "Chiniot District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/chiniot-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Chiniot Member 06", 6),
    createProfile("Chiniot Member 07", 7),
    createProfile("Chiniot Member 08", 8),
    createProfile("Chiniot Member 09", 9),
    createProfile("Chiniot Member 10", 10),
    createProfile("Chiniot Member 11", 11),
    createProfile("Chiniot Member 12", 12),
    createProfile("Chiniot Member 13", 13),
    createProfile("Chiniot Member 14", 14),
    createProfile("Chiniot Member 15", 15),
  ],
};

export default chiniotDistrictData;