...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/bahawalpur-district/image${imageNumber}.jpg`,
...
const bahawalpurDistrictData = {
  title: "Bahawalpur District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/bahawalpur-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Bahawalpur Member 06", 6),
    createProfile("Bahawalpur Member 07", 7),
    createProfile("Bahawalpur Member 08", 8),
    createProfile("Bahawalpur Member 09", 9),
    createProfile("Bahawalpur Member 10", 10),
    createProfile("Bahawalpur Member 11", 11),
    createProfile("Bahawalpur Member 12", 12),
    createProfile("Bahawalpur Member 13", 13),
    createProfile("Bahawalpur Member 14", 14),
    createProfile("Bahawalpur Member 15", 15),
  ],
};

export default bahawalpurDistrictData;