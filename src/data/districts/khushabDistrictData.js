...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/khushab-district/image${imageNumber}.jpg`,
...
const khushabDistrictData = {
  title: "Khushab District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/khushab-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Khushab Member 02", 2),
    createProfile("Khushab Member 03", 3),
    createProfile("Khushab Member 04", 4),
    createProfile("Khushab Member 05", 5),
    createProfile("Khushab Member 06", 6),
    createProfile("Khushab Member 07", 7),
    createProfile("Khushab Member 08", 8),
    createProfile("Khushab Member 09", 9),
    createProfile("Khushab Member 10", 10),
    createProfile("Khushab Member 11", 11),
    createProfile("Khushab Member 12", 12),
    createProfile("Khushab Member 13", 13),
    createProfile("Khushab Member 14", 14),
    createProfile("Khushab Member 15", 15),
  ],
};

export default khushabDistrictData;