...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/jhelum-district/image${imageNumber}.jpeg`,
...
const jhelumDistrictData = {
  title: "Jhelum District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/jhelum-district/hero.jpeg",
  ...
  profiles: [
    ...
    createProfile("Jhelum Member 02", 2),
    createProfile("Jhelum Member 03", 3),
    createProfile("Jhelum Member 04", 4),
    createProfile("Jhelum Member 05", 5),
    createProfile("Jhelum Member 06", 6),
    createProfile("Jhelum Member 07", 7),
    createProfile("Jhelum Member 08", 8),
    createProfile("Jhelum Member 09", 9),
    createProfile("Jhelum Member 10", 10),
    createProfile("Jhelum Member 11", 11),
    createProfile("Jhelum Member 12", 12),
    createProfile("Jhelum Member 13", 13),
    createProfile("Jhelum Member 14", 14),
    createProfile("Jhelum Member 15", 15),
  ],
};

export default jhelumDistrictData;