...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/faisalabad-district/image${imageNumber}.jpg`,
...
const faisalabadDistrictData = {
  title: "Faisalabad District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/faisalabad-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Faisalabad Member 06", 6),
    createProfile("Faisalabad Member 07", 7),
    createProfile("Faisalabad Member 08", 8),
    createProfile("Faisalabad Member 09", 9),
    createProfile("Faisalabad Member 10", 10),
    createProfile("Faisalabad Member 11", 11),
    createProfile("Faisalabad Member 12", 12),
    createProfile("Faisalabad Member 13", 13),
    createProfile("Faisalabad Member 14", 14),
    createProfile("Faisalabad Member 15", 15),
  ],
};

export default faisalabadDistrictData;