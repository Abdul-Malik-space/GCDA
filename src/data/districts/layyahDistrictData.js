...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/layyah-district/image${imageNumber}.jpg`,
...
const layyahDistrictData = {
  title: "Layyah District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/layyah-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Layyah Member 02", 2),
    createProfile("Layyah Member 03", 3),
    createProfile("Layyah Member 04", 4),
    createProfile("Layyah Member 05", 5),
    createProfile("Layyah Member 06", 6),
    createProfile("Layyah Member 07", 7),
    createProfile("Layyah Member 08", 8),
    createProfile("Layyah Member 09", 9),
    createProfile("Layyah Member 10", 10),
    createProfile("Layyah Member 11", 11),
    createProfile("Layyah Member 12", 12),
    createProfile("Layyah Member 13", 13),
    createProfile("Layyah Member 14", 14),
    createProfile("Layyah Member 15", 15),
  ],
};

export default layyahDistrictData;