...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/bahawalnagar-district/image${imageNumber}.jpg`,
...
const bahawalnagarDistrictData = {
  title: "Bahawalnagar District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/bahawalnagar-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Bahawalnagar Member 06", 6),
    createProfile("Bahawalnagar Member 07", 7),
    createProfile("Bahawalnagar Member 08", 8),
    createProfile("Bahawalnagar Member 09", 9),
    createProfile("Bahawalnagar Member 10", 10),
    createProfile("Bahawalnagar Member 11", 11),
    createProfile("Bahawalnagar Member 12", 12),
    createProfile("Bahawalnagar Member 13", 13),
    createProfile("Bahawalnagar Member 14", 14),
    createProfile("Bahawalnagar Member 15", 15),
  ],
};

export default bahawalnagarDistrictData;