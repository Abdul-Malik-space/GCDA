...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/hafizabad-district/image${imageNumber}.jpg`,
...
const hafizabadDistrictData = {
  title: "Hafizabad District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/hafizabad-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Hafizabad Member 02", 2),
    createProfile("Hafizabad Member 03", 3),
    createProfile("Hafizabad Member 04", 4),
    createProfile("Hafizabad Member 05", 5),
    createProfile("Hafizabad Member 06", 6),
    createProfile("Hafizabad Member 07", 7),
    createProfile("Hafizabad Member 08", 8),
    createProfile("Hafizabad Member 09", 9),
    createProfile("Hafizabad Member 10", 10),
    createProfile("Hafizabad Member 11", 11),
    createProfile("Hafizabad Member 12", 12),
    createProfile("Hafizabad Member 13", 13),
    createProfile("Hafizabad Member 14", 14),
    createProfile("Hafizabad Member 15", 15),
  ],
};

export default hafizabadDistrictData;