...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/lodharan-district/image${imageNumber}.jpg`,
...
const lodharanDistrictData = {
  title: "Lodharan District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/lodharan-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Lodharan Member 02", 2),
    createProfile("Lodharan Member 03", 3),
    createProfile("Lodharan Member 04", 4),
    createProfile("Lodharan Member 05", 5),
    createProfile("Lodharan Member 06", 6),
    createProfile("Lodharan Member 07", 7),
    createProfile("Lodharan Member 08", 8),
    createProfile("Lodharan Member 09", 9),
    createProfile("Lodharan Member 10", 10),
    createProfile("Lodharan Member 11", 11),
    createProfile("Lodharan Member 12", 12),
    createProfile("Lodharan Member 13", 13),
    createProfile("Lodharan Member 14", 14),
    createProfile("Lodharan Member 15", 15),
  ],
};

export default lodharanDistrictData;