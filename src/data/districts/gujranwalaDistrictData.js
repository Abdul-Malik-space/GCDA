...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/gujranwala-district/image${imageNumber}.jpg`,
...
const gujranwalaDistrictData = {
  title: "Gujranwala District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/gujranwala-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Gujranwala Member 02", 2),
    createProfile("Gujranwala Member 03", 3),
    createProfile("Gujranwala Member 04", 4),
    createProfile("Gujranwala Member 05", 5),
    createProfile("Gujranwala Member 06", 6),
    createProfile("Gujranwala Member 07", 7),
    createProfile("Gujranwala Member 08", 8),
    createProfile("Gujranwala Member 09", 9),
    createProfile("Gujranwala Member 10", 10),
    createProfile("Gujranwala Member 11", 11),
    createProfile("Gujranwala Member 12", 12),
    createProfile("Gujranwala Member 13", 13),
    createProfile("Gujranwala Member 14", 14),
    createProfile("Gujranwala Member 15", 15),
  ],
};

export default gujranwalaDistrictData;