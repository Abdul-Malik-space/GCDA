...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/mianwali-district/image${imageNumber}.jpg`,
...
const mianwaliDistrictData = {
  title: "Mianwali District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/mianwali-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Dr Mianwali Member 02", 2),
    createProfile("Dr Mianwali Member 03", 3),
    createProfile("Dr Mianwali Member 04", 4),
    createProfile("Dr Mianwali Member 05", 5),
    createProfile("Dr Mianwali Member 06", 6),
    createProfile("Dr Mianwali Member 07", 7),
    createProfile("Dr Mianwali Member 08", 8),
    createProfile("Dr Mianwali Member 09", 9),
    createProfile("Dr Mianwali Member 10", 10),
    createProfile("Dr Mianwali Member 11", 11),
    createProfile("Dr Mianwali Member 12", 12),
    createProfile("Dr Mianwali Member 13", 13),
    createProfile("Dr Mianwali Member 14", 14),
    createProfile("Dr Mianwali Member 15", 15),
  ],
};

export default mianwaliDistrictData;