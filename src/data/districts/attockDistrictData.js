const sharedProfileDetails = {
  ...
  personalCareerInterests: [
    "Dr. Masood Akhtar Sheikh is serving as President, General Cadre Doctors Association. He is a distinguished medical professional and administrative figure with a broad background in healthcare management, public health, human resource management, medico-legal understanding, and professional representation.",
  ...
  previousOfficialPositions: [
    { officialBody: "District Council", post: "Chairman", duration: "1987-1993" },
    { officialBody: "District Council", post: "Vice Chairman", duration: "1983-1987" },
    { officialBody: "Provincial Assembly of the Punjab", post: "MPA", duration: "1993-1996" },
    { officialBody: "Provincial Assembly of the Punjab", post: "Minister for Live Stock & Dairy Development", duration: "1997-1999" },
    { officialBody: "Provincial Assembly of the Punjab", post: "Speaker", duration: "2008-2018" },
  ],
...
const createProfile = (name, imageNumber) => ({
  id: name
    .toLowerCase()
    .replace("dr.", "dr")
    .replace(/[^a-z0-9]+/g, "-")
    .replace(/^-|-$/g, ""),
  name,
  image: `/assets/images/districtBody/attock-district/image${imageNumber}.jpg`,
  shortDescription:
...
const attockDistrictData = {
  title: "Attock District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/attock-district/hero.jpg",

  profiles: [
    {
      id: "dr-masood-akhtar-sheikh",
      name: "Dr Masood Akhtar Sheikh",
      image: "/assets/images/districtBody/attock-district/image1.jpg",
      shortDescription:
        "President GCDA with experience in medical administration, public health, human resource management, medico-legal matters, and professional leadership.",
      ...sharedProfileDetails,
    },
    ...
    createProfile("Attock Member 06", 6),
    createProfile("Attock Member 07", 7),
    createProfile("Attock Member 08", 8),
    createProfile("Attock Member 09", 9),
    createProfile("Attock Member 10", 10),
    createProfile("Attock Member 11", 11),
    createProfile("Attock Member 12", 12),
    createProfile("Attock Member 13", 13),
    createProfile("Attock Member 14", 14),
    createProfile("Attock Member 15", 15),
  ],
};

export default attockDistrictData;
