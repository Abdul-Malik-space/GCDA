...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/lahore-district/image${imageNumber}.jpg`,
...
const lahoreDistrictData = {
  title: "Lahore District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/lahore-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Lahore Member 02", 2),
    createProfile("Lahore Member 03", 3),
    createProfile("Lahore Member 04", 4),
    createProfile("Lahore Member 05", 5),
    createProfile("Lahore Member 06", 6),
    createProfile("Lahore Member 07", 7),
    createProfile("Lahore Member 08", 8),
    createProfile("Lahore Member 09", 9),
    createProfile("Lahore Member 10", 10),
    createProfile("Lahore Member 11", 11),
    createProfile("Lahore Member 12", 12),
    createProfile("Lahore Member 13", 13),
    createProfile("Lahore Member 14", 14),
    createProfile("Lahore Member 15", 15),
  ],
};

export default lahoreDistrictData;