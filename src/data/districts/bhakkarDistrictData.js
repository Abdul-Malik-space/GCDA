...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/bhakkar-district/image${imageNumber}.jpg`,
...
const bhakkarDistrictData = {
  title: "Bhakkar District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/bhakkar-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Bhakkar Member 06", 6),
    createProfile("Bhakkar Member 07", 7),
    createProfile("Bhakkar Member 08", 8),
    createProfile("Bhakkar Member 09", 9),
    createProfile("Bhakkar Member 10", 10),
    createProfile("Bhakkar Member 11", 11),
    createProfile("Bhakkar Member 12", 12),
    createProfile("Bhakkar Member 13", 13),
    createProfile("Bhakkar Member 14", 14),
    createProfile("Bhakkar Member 15", 15),
  ],
};

export default bhakkarDistrictData;