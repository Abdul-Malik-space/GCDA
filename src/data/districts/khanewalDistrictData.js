...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/khanewal-district/image${imageNumber}.jpg`,
...
const khanewalDistrictData = {
  title: "Khanewal District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/khanewal-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Khanewal Member 02", 2),
    createProfile("Khanewal Member 03", 3),
    createProfile("Khanewal Member 04", 4),
    createProfile("Khanewal Member 05", 5),
    createProfile("Khanewal Member 06", 6),
    createProfile("Khanewal Member 07", 7),
    createProfile("Khanewal Member 08", 8),
    createProfile("Khanewal Member 09", 9),
    createProfile("Khanewal Member 10", 10),
    createProfile("Khanewal Member 11", 11),
    createProfile("Khanewal Member 12", 12),
    createProfile("Khanewal Member 13", 13),
    createProfile("Khanewal Member 14", 14),
    createProfile("Khanewal Member 15", 15),
  ],
};

export default khanewalDistrictData;