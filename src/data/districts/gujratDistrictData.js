...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/gujrat-district/image${imageNumber}.jpg`,
...
const gujratDistrictData = {
  title: "Gujrat District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/gujrat-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Gujrat Member 02", 2),
    createProfile("Gujrat Member 03", 3),
    createProfile("Gujrat Member 04", 4),
    createProfile("Gujrat Member 05", 5),
    createProfile("Gujrat Member 06", 6),
    createProfile("Gujrat Member 07", 7),
    createProfile("Gujrat Member 08", 8),
    createProfile("Gujrat Member 09", 9),
    createProfile("Gujrat Member 10", 10),
    createProfile("Gujrat Member 11", 11),
    createProfile("Gujrat Member 12", 12),
    createProfile("Gujrat Member 13", 13),
    createProfile("Gujrat Member 14", 14),
    createProfile("Gujrat Member 15", 15),
  ],
};

export default gujratDistrictData;