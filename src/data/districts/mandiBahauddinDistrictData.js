...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/mandi-bahauddin-district/image${imageNumber}.jpg`,
...
const mandiBahauddinDistrictData = {
  title: "Mandi Bahauddin District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/mandi-bahauddin-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Mandi Bahauddin Member 02", 2),
    createProfile("Mandi Bahauddin Member 03", 3),
    createProfile("Mandi Bahauddin Member 04", 4),
    createProfile("Mandi Bahauddin Member 05", 5),
    createProfile("Mandi Bahauddin Member 06", 6),
    createProfile("Mandi Bahauddin Member 07", 7),
    createProfile("Mandi Bahauddin Member 08", 8),
    createProfile("Mandi Bahauddin Member 09", 9),
    createProfile("Mandi Bahauddin Member 10", 10),
    createProfile("Mandi Bahauddin Member 11", 11),
    createProfile("Mandi Bahauddin Member 12", 12),
    createProfile("Mandi Bahauddin Member 13", 13),
    createProfile("Mandi Bahauddin Member 14", 14),
    createProfile("Mandi Bahauddin Member 15", 15),
  ],
};

export default mandiBahauddinDistrictData;