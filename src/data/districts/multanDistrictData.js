...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/multan-district/image${imageNumber}.jpg`,
...
const multanDistrictData = {
  title: "Multan District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/multan-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Dr Multan Member 02", 2),
    createProfile("Dr Multan Member 03", 3),
    createProfile("Dr Multan Member 04", 4),
    createProfile("Dr Multan Member 05", 5),
    createProfile("Dr Multan Member 06", 6),
    createProfile("Dr Multan Member 07", 7),
    createProfile("Dr Multan Member 08", 8),
    createProfile("Dr Multan Member 09", 9),
    createProfile("Dr Multan Member 10", 10),
    createProfile("Dr Multan Member 11", 11),
    createProfile("Dr Multan Member 12", 12),
    createProfile("Dr Multan Member 13", 13),
    createProfile("Dr Multan Member 14", 14),
    createProfile("Dr Multan Member 15", 15),
  ],
};

export default multanDistrictData;