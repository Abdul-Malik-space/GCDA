...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/districtBody/chakwal-district/image${imageNumber}.jpg`,
...
const chakwalDistrictData = {
  title: "Chakwal District Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/districtBody/chakwal-district/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Chakwal Member 06", 6),
    createProfile("Chakwal Member 07", 7),
    createProfile("Chakwal Member 08", 8),
    createProfile("Chakwal Member 09", 9),
    createProfile("Chakwal Member 10", 10),
    createProfile("Chakwal Member 11", 11),
    createProfile("Chakwal Member 12", 12),
    createProfile("Chakwal Member 13", 13),
    createProfile("Chakwal Member 14", 14),
    createProfile("Chakwal Member 15", 15),
  ],
};

export default chakwalDistrictData;