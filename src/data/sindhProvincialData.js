...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/provincialBody/sindh/image${imageNumber}.jpeg`,
...
const sindhProvincialData = {
  title: "Sindh Provincial Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/provincialBody/sindh/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Sindh Member 06", 6),
    createProfile("Sindh Member 07", 7),
    createProfile("Sindh Member 08", 8),
    createProfile("Sindh Member 09", 9),
    createProfile("Sindh Member 10", 10),
    createProfile("Sindh Member 11", 11),
    createProfile("Sindh Member 12", 12),
    createProfile("Sindh Member 13", 13),
    createProfile("Sindh Member 14", 14),
    createProfile("Sindh Member 15", 15),
  ],
};

export default sindhProvincialData;