...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/provincialBody/punjab/image${imageNumber}.jpeg`,
...
const punjabProvincialData = {
  title: "Punjab Provincial Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/provincialBody/punjab/image1.jpeg",
  ...
  profiles: [
    ...
    createProfile("Punjab Member 06", 6),
    createProfile("Punjab Member 07", 7),
    createProfile("Punjab Member 08", 8),
    createProfile("Punjab Member 09", 9),
    createProfile("Punjab Member 10", 10),
    createProfile("Punjab Member 11", 11),
    createProfile("Punjab Member 12", 12),
    createProfile("Punjab Member 13", 13),
    createProfile("Punjab Member 14", 14),
    createProfile("Punjab Member 15", 15),
  ],
};

export default punjabProvincialData;