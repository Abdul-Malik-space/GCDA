...
const createProfile = (name, imageNumber, shortDescription) => ({
  ...
  image: `/assets/images/provincialBody/azad-jammu-kashmir/image${imageNumber}.jpg`,
...
const azadJammuKashmirProvincialData = {
  title: "Azad Jammu Kashmir Provincial Body",
  subtitle: "General Cadre Doctors Association",

  heroImage: "/assets/images/provincialBody/azad-jammu-kashmir/hero.jpg",
  ...
  profiles: [
    ...
    createProfile("Azad Jammu Kashmir Member 06", 6),
    createProfile("Azad Jammu Kashmir Member 07", 7),
    createProfile("Azad Jammu Kashmir Member 08", 8),
    createProfile("Azad Jammu Kashmir Member 09", 9),
    createProfile("Azad Jammu Kashmir Member 10", 10),
    createProfile("Azad Jammu Kashmir Member 11", 11),
    createProfile("Azad Jammu Kashmir Member 12", 12),
    createProfile("Azad Jammu Kashmir Member 13", 13),
    createProfile("Azad Jammu Kashmir Member 14", 14),
    createProfile("Azad Jammu Kashmir Member 15", 15),
  ],
};

export default azadJammuKashmirProvincialData;