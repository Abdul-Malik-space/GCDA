...
function AzadJammuKashmirProfileDetails() {
  const { profileId } = useParams();

  const profile = azadJammuKashmirProvincialData.profiles.find(
  ...
  return (
    <main className="w-full bg-white">
      <section className="max-w-[1200px] mx-auto px-4 py-8 md:py-10">
        <Link
          to="/branches/provincial/azad-jammu-kashmir"
          className="inline-block mb-6 text-sm font-bold text-[#1A7963] hover:underline"
        >
          ← Back to Azad Jammu Kashmir Provincial Body
        </Link>
...
export default AzadJammuKashmirProfileDetails;