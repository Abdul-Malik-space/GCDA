...
function HouseOfDelegates() {
  const data = delegatesData;
  ...
  const profileRows = [
    {
      id: 1,
      title: "Punjab Delegates",
      profiles: firstRowProfiles,
    },
    {
      id: 2,
      title: "Sindh Delegates",
  ...
  <Link
    to={`/about/house-delegates/profile/${profile.id}`}
