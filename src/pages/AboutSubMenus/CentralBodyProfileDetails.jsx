...
function CentralBodyProfileDetails() {
  const { profileId } = useParams();

  const profile = centralBodyData.profiles.find(
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[370px_1fr] gap-8 items-start">
          <aside className="bg-slate-700 text-white shadow-lg overflow-hidden">
            ...
            <div className="px-8 pb-8 space-y-5">
              ...
              <SideSection title="Central Body Role">
                {profile.role}
              </SideSection>
...
export default CentralBodyProfileDetails;