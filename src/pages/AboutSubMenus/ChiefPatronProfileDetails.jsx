...
import chiefPatronData from "../../data/chiefPatronData";
...
function ChiefPatronProfileDetails() {
  const { profileId } = useParams();

  const profile = chiefPatronData.profiles.find(
...
export default ChiefPatronProfileDetails;