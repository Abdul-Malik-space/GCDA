...
import balochistanProvincialData from "../data/balochistanProvincialData";
...
function BalochistanProfileDetails() {
  const { profileId } = useParams();

  const profile = balochistanProvincialData.profiles.find(
...
export default BalochistanProfileDetails;