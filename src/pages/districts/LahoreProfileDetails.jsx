...
import lahoreDistrictData from "../../data/districts/lahoreDistrictData";
...
function LahoreProfileDetails() {
  const { profileId } = useParams();

  const profile = lahoreDistrictData.profiles.find(
...
export default LahoreProfileDetails;