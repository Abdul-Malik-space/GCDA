...
import hafizabadDistrictData from "../../data/districts/hafizabadDistrictData";
...
function HafizabadProfileDetails() {
  const { profileId } = useParams();

  const profile = hafizabadDistrictData.profiles.find(
...
export default HafizabadProfileDetails;