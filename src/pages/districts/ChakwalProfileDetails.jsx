...
import chakwalDistrictData from "../../data/districts/chakwalDistrictData";
...
function ChakwalProfileDetails() {
  const { profileId } = useParams();

  const profile = chakwalDistrictData.profiles.find(
...
export default ChakwalProfileDetails;