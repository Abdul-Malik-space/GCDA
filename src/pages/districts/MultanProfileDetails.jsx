...
function MultanProfileDetails() {
  const { profileId } = useParams();

  const profile = multanDistrictData.profiles.find(
...
export default MultanProfileDetails;