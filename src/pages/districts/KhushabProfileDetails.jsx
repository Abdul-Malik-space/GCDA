...
function KhushabProfileDetails() {
  const { profileId } = useParams();

  const profile = khushabDistrictData.profiles.find(
...
export default KhushabProfileDetails;