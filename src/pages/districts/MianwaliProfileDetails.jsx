...
import mianwaliDistrictData from "../../data/districts/mianwaliDistrictData";
...
function MianwaliProfileDetails() {
  const { profileId } = useParams();

  const profile = mianwaliDistrictData.profiles.find(
...
export default MianwaliProfileDetails;