...
import khanewalDistrictData from "../../data/districts/khanewalDistrictData";
...
function KhanewalProfileDetails() {
  const { profileId } = useParams();

  const profile = khanewalDistrictData.profiles.find(
...
export default KhanewalProfileDetails;