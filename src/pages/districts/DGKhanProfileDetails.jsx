...
import dgKhanDistrictData from "../../data/districts/dgKhanDistrictData";
...
function DGKhanProfileDetails() {
  const { profileId } = useParams();

  const profile = dgKhanDistrictData.profiles.find(
...
export default DGKhanProfileDetails;