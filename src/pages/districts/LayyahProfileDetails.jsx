...
import layyahDistrictData from "../../data/districts/layyahDistrictData";
...
function LayyahProfileDetails() {
  const { profileId } = useParams();

  const profile = layyahDistrictData.profiles.find(
...
export default LayyahProfileDetails;