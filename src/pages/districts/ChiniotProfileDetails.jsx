...
function ChiniotProfileDetails() {
  const { profileId } = useParams();

  const profile = chiniotDistrictData.profiles.find(
...
export default ChiniotProfileDetails;