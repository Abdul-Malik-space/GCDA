...
import jhelumDistrictData from "../../data/districts/jhelumDistrictData";
...
function JhelumProfileDetails() {
  const { profileId } = useParams();

  const profile = jhelumDistrictData.profiles.find(
...
export default JhelumProfileDetails;