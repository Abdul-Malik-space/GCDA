...
function MandiBahauddinDistrictBody() {
  const data = mandiBahauddinDistrictData;
  const featuredProfile = data.profiles?.[0];
  const otherProfiles = data.profiles?.slice(1) || [];
  const districtSlug = "mandi-bahauddin-district";
...
export default MandiBahauddinDistrictBody;