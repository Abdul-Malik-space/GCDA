...
import mandiBahauddinDistrictData from "../../data/districts/mandiBahauddinDistrictData";
...
function MandiBahauddinProfileDetails() {
  const { profileId } = useParams();

  const profile = mandiBahauddinDistrictData.profiles.find(
  ...
  return (
    <main className="w-full bg-white">
      <section className="max-w-[1200px] mx-auto px-4 py-8 md:py-10">
        <Link
          to="/branches/district/mandi-bahauddin-district"
          className="inline-block mb-6 text-sm font-bold text-[#1A7963] hover:underline"
        >
          ← Back to Mandi Bahauddin District Body
        </Link>
          ...
          <div className="space-y-8">
            ...
            <section className="bg-white border border-slate-100 shadow-sm rounded-xl p-6">
              ...
              <div className="mt-4 space-y-6">
                <div>
                  <h3 className="font-black text-slate-800">Educational</h3>
                  <BulletList items={profile.keyAchievements?.educational} />
                </div>

                <div>
                  <h3 className="font-black text-slate-800">Administrative</h3>
                  <BulletList items={profile.keyAchievements?.administrative} />
                </div>

                <div>
                  <h3 className="font-black text-slate-800">Sociopolitical</h3>
                  <BulletList items={profile.keyAchievements?.sociopolitical} />
                </div>
              </div>
            </section>
...
export default MandiBahauddinProfileDetails;