...
import attockDistrictData from "../../data/districts/attockDistrictData";
...
function AttockProfileDetails() {
  const { profileId } = useParams();

  const profile = attockDistrictData.profiles.find(
...
export default AttockProfileDetails;