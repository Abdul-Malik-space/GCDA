...
function GujranwalaDistrictBody() {
  const data = gujranwalaDistrictData;
  const featuredProfile = data.profiles?.[0];
  const otherProfiles = data.profiles?.slice(1) || [];
  const districtSlug = "gujranwala-district";
  ...
  return (
    <main className="w-full bg-white">
      ...
      {/* FIRST PROFILE SMALL AND CENTERED */}
      {featuredProfile && (
...
export default GujranwalaDistrictBody;