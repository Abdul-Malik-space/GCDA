...
import gujratDistrictData from "../../data/districts/gujratDistrictData";
...
function GujratProfileDetails() {
  const { profileId } = useParams();

  const profile = gujratDistrictData.profiles.find(
...
export default GujratProfileDetails;