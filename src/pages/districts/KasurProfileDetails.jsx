...
import kasurDistrictData from "../../data/districts/kasurDistrictData";
...
function KasurProfileDetails() {
  const { profileId } = useParams();

  const profile = kasurDistrictData.profiles.find(
...
export default KasurProfileDetails;