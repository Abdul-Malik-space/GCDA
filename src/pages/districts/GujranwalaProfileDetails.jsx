...
import gujranwalaDistrictData from "../../data/districts/gujranwalaDistrictData";
...
function GujranwalaProfileDetails() {
  const { profileId } = useParams();

  const profile = gujranwalaDistrictData.profiles.find(
...
export default GujranwalaProfileDetails;