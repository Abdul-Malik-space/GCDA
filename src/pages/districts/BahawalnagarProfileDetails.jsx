...
function BahawalnagarProfileDetails() {
  const { profileId } = useParams();

  const profile = bahawalnagarDistrictData.profiles.find(
  ...
  return (
    <main className="w-full bg-white">
      <section className="max-w-[1200px] mx-auto px-4 py-8 md:py-10">
        <Link
          to="/branches/district/bahawalnagar-district"
          className="inline-block mb-6 text-sm font-bold text-[#1A7963] hover:underline"
        >
          ← Back to Bahawalnagar District Body
        </Link>
...
export default BahawalnagarProfileDetails;