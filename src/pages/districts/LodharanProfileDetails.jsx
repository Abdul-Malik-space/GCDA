...
import lodharanDistrictData from "../../data/districts/lodharanDistrictData";
...
function LodharanProfileDetails() {
  const { profileId } = useParams();

  const profile = lodharanDistrictData.profiles.find(
...
export default LodharanProfileDetails;