...
import bahawalpurDistrictData from "../../data/districts/bahawalpurDistrictData";
...
function BahawalpurProfileDetails() {
  const { profileId } = useParams();

  const profile = bahawalpurDistrictData.profiles.find(
...
export default BahawalpurProfileDetails;