...
function FaisalabadProfileDetails() {
  const { profileId } = useParams();

  const profile = faisalabadDistrictData.profiles.find(
...
export default FaisalabadProfileDetails;