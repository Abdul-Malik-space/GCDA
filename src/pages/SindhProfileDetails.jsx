...
import sindhProvincialData from "../data/sindhProvincialData";
...
function SindhProfileDetails() {
  const { profileId } = useParams();

  const profile = sindhProvincialData.profiles.find(
...
export default SindhProfileDetails;