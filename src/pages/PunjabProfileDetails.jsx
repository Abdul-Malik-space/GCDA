...
import punjabProvincialData from "../data/punjabProvincialData";
...
function PunjabProfileDetails() {
  const { profileId } = useParams();

  const profile = punjabProvincialData.profiles.find(
...
export default PunjabProfileDetails;