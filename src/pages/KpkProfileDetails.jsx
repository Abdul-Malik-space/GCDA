...
import kpkProvincialData from "../data/kpkProvincialData";
...
function KpkProfileDetails() {
  const { profileId } = useParams();

  const profile = kpkProvincialData.profiles.find(
...
export default KpkProfileDetails;